...
def create_weighted_vote_chart(results_dict: Dict[str, Dict], title: str = "Weighted Voting Results"):
    """
...
def create_first_preferences_pie_chart(ballots: List[List[str]], candidates: List):
    ...
    fig.update_layout(
        ...
        annotations=[dict(text='First<br>Preferences', x=0.5, y=0.5, font_size=16, showarrow=False)]
    )
