...
def main_no_charts():
    ...
    result_equal = run_weighted_yes_no_election(profiles, yes_ids, no_ids, coeffs_equal, 0.5, bounds)
    result_expert = run_weighted_yes_no_election(profiles, yes_ids, no_ids, coeffs_expert, 0.5, bounds)
    result_stake = run_weighted_yes_no_election(profiles, yes_ids, no_ids, coeffs_stake, 0.5, bounds)
    
    print(f"\n1. Equal weights: {result_equal['passed']} ({result_equal['total_yes']:.2f} vs {result_equal['total_no']:.2f})")
    print(f"2. Expertise focus: {result_expert['passed']} ({result_expert['total_yes']:.2f} vs {result_expert['total_no']:.2f})")
    print(f"3. Stake focus: {result_stake['passed']} ({result_stake['total_yes']:.2f} vs {result_stake['total_no']:.2f})")
